...
public class Test {
    ...
    static void runTest(){
        ...
        public static void main(String[] args) {
            ...
            String result = Function.compareToTest(1, 2.54);
            compareResultToExpectedResult(result, Function.out1);
            //Faktisk output: 2.54
            //Test result: PASS
            ...
            String result2 = Function.compareToTest(10, 25.4);
            compareResultToExpectedResult(result2, Function.out1);
            //Faktisk output: 25.4;
            //Test result: PASS
            ...
            // Input: 0
            // Forventet output: 0
            String result3 = Function.compareToTest(0,0);
            compareResultToExpectedResult(result3, Function.out1);
            // Faktisk output: 0
            // Test result: PASS
            ...
            String result4 = Function.compareToTest(-10, 0);
            compareResultToExpectedResult(result3, Function.out1);
            ...
            String result5 = Function.compareToTest(7,17.78);
            compareResultToExpectedResult(result3, Function.out1);
            // Faktisk output: Error
            // Test result: Not correct because the compareNumbers can't handle error messages
